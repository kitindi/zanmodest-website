    ...
    <div className="w-full ">
      ...
      <div className="w-full max-w-6xl mx-auto py-8">
        <div className="grid grid-cols-2 py-16">
          <div className="">
            {" "}
            <h2 className="text-4xl text-[#512731] w-full max-w-2xl leading-relaxed font-medium">
              Let us be your guide on tailored journeys through Zanzibar.
            </h2>
          </div>
          <div>
            <p className=" text-[#512731] text-lg leading-relaxed mb-3">
            ...
            <div className="grid grid-cols-2 gap-5 mt-5">
              ...
              <div className="flex items-center justify-start gap-2">
                ...
                <div>
                  {" "}
                  <p className="text-md font-medium text-[#512731]">Modest-Friendly Tours</p>
              ...
              <div className="flex items-center justify-start gap-2">
                ...
                <div className="flex-grow">
                  <p className="text-md font-medium text-[#512731]">Expert Local Guides</p>
              ...
              <div className="flex items-center justify-start gap-2">
                ...
                <div>
                  <p className="text-md font-medium text-[#512731]">Cultural Respect</p>
              ...
              <div className="flex items-center justify-start gap-2">
                ...
                <div>
                  <p className="text-md font-medium text-[#512731]">Licensed Operator</p>
                  <p className="text-md font-normal leading-5 mt-2 text-[#512731]">
