      ...
      <div className="w-full flex items-center justify-between max-w-6xl mx-auto ">
        <div className="flex flex-col md:grid md:grid-cols-5">
          <div className="w-full md:col-span-2 md:pr-32">
            <img src={`./images/brown-logo.svg`} alt="" className="w-38 mb-3 mx-auto md:block" />
            ...
            <div className="w-full">
              ...
              <p className="hidden md:block text-[10px] mt-3 text-[#512731] pt-3">
          ...
          <div className="pt-8">
            <div>
              ...
              <span className="md:hidden flex items-center gap-3 text-sm text-[#512731] font-medium">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
              ...
              <span className="md:hidden flex items-center gap-3 text-sm text-[#512731] font-medium mb-10 md:mb-0">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
          ...
          <div className="pt-8">
            <div>
              <span className="hidden md:flex items-center gap-3 text-sm text-[#512731] font-medium">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
          ...
          <div className="pt-8">
            ...
            <div className="pt-3 md:pt-14 px-2 text-[#522731]">
