...
const Hero = () => {
  return (
    <div className="relative h-[60vh] md:h-[80vh] w-full  bg-[url(/images/hero-1.jpg)] bg-cover bg-center bg-no-repeat">
      <div className="relative w-full max-w-6xl mx-auto flex items-center  h-full">
        <div className="absolute left-0 top-16 md:top-28 z-20 mt-10 px-4 md:px-0">
